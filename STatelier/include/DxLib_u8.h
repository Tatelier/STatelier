...
int32_t CreateFontToHandle(const char8_t* FontName, int32_t Size, int32_t Thick, int32_t FontType = -1, int32_t CharSet = -1, int32_t EdgeSize = -1, int32_t Italic = FALSE, int32_t Handle = -1);
